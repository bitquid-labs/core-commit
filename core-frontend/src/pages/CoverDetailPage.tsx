...
const CoverDetailPage: React.FC = () => {
  ...
  return (
    <div className="w-[90%] md:w-full mx-auto max-w-1220 md:pt-70 pt-10">
      ...
      <div className="mt-20 w-full bg-[#6B72801A] border border-[#6B7280] rounded-20 overflow-hidden md:px-42 md:py-22 p-20">
        <div className="flex items-center justify-between scale-90 md:scale-100 gap-8 md:gap-0"> 
          <div className="flex items-center">
            <div className="bg-[#FFF] rounded-full w-47 md:h-47 overflow-hidden">
          ...
          >
            <div className="md:pl-8 pl-2 md:text-m text-[12px]">Terms & Conditions</div>
