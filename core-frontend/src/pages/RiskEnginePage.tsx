...
const RiskEngine: React.FC = () => {
    ...
    return (
        <div className={`bg-black text-white md:w-full w-[85%] mx-auto`}>
            <header className="text-center py-20 mt-20">
                <h1 className="md:text-6xl text-5xl font-semibold pb-5">
                    Welcome to <span className="text-[#00ecbc]">Risk Engine</span>
                </h1>
                <p className="text-gray-400 mt-20 max-w-2xl mx-auto mb-28 md:text-m text-sm">
            ...
            {!isAnimating && (
                <>
                    ...
                    <div className='flex justify-start items-center'>
                        <h2 className="text-2xl font-semibold md:pl-[8rem] pl=5 pr-20">Parameters used</h2>
                        <div className="my-32 w-[25%] bg-gradient bg-gradient-to-r from-[#FFFFFF] to-[#161618] h-1"></div>
                    </div>

                    <div className="bg-black text-white py-10 px-6 sm:px-12 md:w-[75%] w-full mx-auto">
