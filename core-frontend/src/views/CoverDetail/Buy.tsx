...
const Buy: React.FC<BuyProps> = (props) => {
  ...
  return (
    <div className="w-full bg-[#FFFFFF0D] border border-[#FFFFFF33] rounded-10 md:px-34 md:py-60 px-20 py-28">
      ...
      <div className=" mt-10 md:mt-60 flex flex-col gap-[8px]">
        <div className="font-[600] text-15 md:mt-0 mt-8">Tenure Period</div>
        <div className="flex flex-col md:flex-row items-start md:gap-0 gap-18 md:items-end justify-between">
